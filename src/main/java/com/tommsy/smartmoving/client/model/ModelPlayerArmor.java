...
public class ModelPlayerArmor extends ModelBiped implements SmartMovingModelBiped {
    ...
    public void setRotationAngles(float totalHorizontalDistance, float currentHorizontalSpeed, float ageInTicks, float headYawAngle, float headPitchAngle, float scaleFactor,
            Entity entity) {
        reset();
        ...
        if (firstPerson || isInventory) {
            ...
            super.setRotationAngles(totalHorizontalDistance, currentHorizontalSpeed, ageInTicks, headYawAngle, headPitchAngle, scaleFactor, entity);
        }
    ...
    private void reset() {
        ...
        smBipedRightShoulder.setRotationPoint(-5F, 2.0F, 0.0F);
        smBipedLeftShoulder.setRotationPoint(5F, 2.0F, 0.0F);
